  ...
  plugins: [
    laravel({
      input: [
        ...
        "resources/js/pages/admin/marketing_campaign.js",
        // front
        "resources/css/front/style.css",
        "resources/css/front/style-rtl.css",
        "resources/js/pages/front/main.js",
        "resources/js/pages/front/search_courses_nav.js",
        "resources/js/pages/front/summernote.js",
        "resources/js/pages/front/timer_quiz.js",
